    ...
    <>
      {/* <div className="footercontainer">
        <footer className="footerbox ">
          <div className="ftop flex">
            <div className="flogo ">
              <div className="flogoleft"></div>
              <div className="flogoright w-fit">Logoss</div>
            </div>
            <div className="fcall flex">
              <div className="fcallleft"></div>
              <div className="fcallright">
                <div className="fcalltext">Call Us</div>
                <div className="fcallnumber">+01 569 896 654</div>
              </div>
            </div>
            <div className="fmail flex">
              <div className="fmailleft"></div>
              <div className="fmailright">
                <div className="fmailtext">Mail Us</div>
                <div className="fmailnumber">Info@Example.com</div>
              </div>
            </div>
            <div className="flocation  flex">
              <div className="flocation left"></div>
              <div className="flocation right">
                <div className="flocation text">Location</div>
                <div className="flocation number">Amsterdam, 109-74</div>
              </div>
            </div>
          </div>
          <div className="fmid">mid </div>
