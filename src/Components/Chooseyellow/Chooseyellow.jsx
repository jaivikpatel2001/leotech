        ...
        <div className="bottom m-auto flex z-10">
          <div className="corerightlefty gap-2">
            ...
            <div className="inovationy bg-white rounded-md">
              ...
              <div className="inovationtitle ">Client Success Stories</div>
              <div className="inovationdesc">
            ...
            <div className="inovationy bg-white rounded-md">
              ...
              <div className="inovationtitle ">Customized Solutions</div>
              <div className="inovationdesc">
                We understand that each client is unique, and our solutions are
                tailor-made to address specific needs.
              </div>
            </div>
            <div className="inovationy bg-white rounded-md ">
              <div className="collabicon"></div>
              <div className="inovationtitle ">Proven Track Record</div>
              <div className="inovationdesc">
